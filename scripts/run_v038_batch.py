#!/usr/bin/env python3
"""Run a v0.3.8 agent group (development or qualification) with bounded parallelism.

Each (suite, run) pair is executed by `scripts/run_v038_agent.py` as its own fresh
