#!/usr/bin/env python3
"""Validate and hash-lock the Opus + Sol scaffold-ladder screen's 24 runs."""
...
def main() -> None:
    ...
    lock_file = arguments.suite_root / "scaffold_ladder_agent_runs.lock.json"
    if lock_file.exists():
        raise SystemExit("v0.4.0 scaffold-ladder outputs are already locked")
    ...
    print(json.dumps({"locked": True, "study": "scaffold-ladder-screen", "runs": len(records)}, indent=2))
