#!/usr/bin/env python3
"""Run the cycle-budget ablation (12 runs) with bounded parallelism.
...
def main() -> None:
    ...
    print(json.dumps({"study": "cycle-budget-ablation", "pending": len(pending), "failures": failures}, indent=2))
    if failures:
        raise SystemExit(1)
