#!/usr/bin/env python3
"""Run the Opus + Sol scaffold-ladder Stage 2 follow-up (18 runs) with bounded parallelism.
...
def main() -> None:
    ...
    print(json.dumps({"study": "scaffold-ladder-stage2", "pending": len(pending), "failures": failures}, indent=2))
    if failures:
        raise SystemExit(1)
