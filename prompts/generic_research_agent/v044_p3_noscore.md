# Full-Feature Research Agent v0.4.4 — P3 (no-feedback)
...
extending it: construct the strongest case that its cross-validated score is misleading —
that it is exploiting something specific to the research rows (fold artifacts, leakage,
a spurious feature) rather than a real, generalizable pattern — and actively look for
evidence supporting that alternative. Only finalize with your current approach if this
attack fails to turn up something a skeptical reviewer would find convincing. If it
succeeds, revise your approach and record why. Note in `approach_summary` what you
attacked and what you found.
...
```json
{
  ...
  "approach_summary": "<free text: what you tried, what you found when you attacked your own best approach, and why you settled on your final approach>",
