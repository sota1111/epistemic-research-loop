...
| Epistemic arm の完了実験数 | 21 |
| 自動起票された Linear イシュー | **21 件**（SOT-3058 〜 SOT-3077 ほか） |
| Kaggle 提出 | **1 回**（上限 5 回 / 日） |
| Leaderboard 読み取り | 1 回（予算 5 のうち 1 消費） |
| CPU 時間 | 12.85 時間（24 コア並列、実時間ベースでは約 1.5 時間） |
...
これが検証の主眼である。全 21 実験の系列を、**なぜその実験になったか**とともに示す。
...
完了 21 実験の種別内訳: diagnostic 7 / falsification 6 / replication 5 / ablation 3 / optimization 0。
...
- **exploiter arm との対比**は `arm_comparison.md` を参照。
